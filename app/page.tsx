    ...
    <main>
      ...
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <h1>رتب مباراتك، ادع أصدقائك، وخل الملعب يكمل أسرع.</h1>
      ...
      <section className="section intro-band" aria-label="عن تطبيق تلعب">
        <div>
          ...
          <h2>الهدف من تطبيق تلعب.</h2>
        </div>
        <p>
          يهدف تطبيق تلعب إلى تسهيل تنظيم مباريات البادل وتقليل الحاجة إلى
          التنسيق الطويل قبل المباراة. يمكن لمنشئ المباراة إنشاء مباراة، تحديد
          من تصلهم الدعوة، مراجعة طلبات الانضمام للمباريات العامة، وإبلاغ
          المشاركين عند تعديل الوقت أو تفاصيل المباراة.
        </p>
      </section>
      ...
      <section className="section privacy-preview">
        <div>
          ...
          <h2>منطقتك الشخصية لا تظهر للناس كعنوان عام.</h2>
          <p>
